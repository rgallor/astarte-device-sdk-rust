...
mod test {
    ...
    use astarte_message_hub_proto::{message_hub_server::{MessageHub, MessageHubServer}, AstarteMessage, AstarteUnset, OptionalProperty, PropertyIdentifier, StoredProperties, StoredPropertiesFilter};
    ...
    impl MessageHub for TestMessageHubServer {
        ...
        async fn get_property(&self, _request: Request<PropertyIdentifier>) -> Result<Response<OptionalProperty>, Status> {
            todo!()
        }
    }
